<template>
  <NarrowContainer class="mb-20 px-4 md:px-0 text-white" data-testid="wishlist-layout">
    <HeaderWithLink
      ...
      <i18n-t keypath="excludedShipping" scope="global">
        <template #shipping>
          <SfLink
            ...
            target="_blank"
            class="focus:outline !text-secondary-500 focus:outline-offset-2 focus:outline-2 outline-secondary-600 rounded"
          >
            {{ $t('delivery') }}
          </SfLink>
        </template>
