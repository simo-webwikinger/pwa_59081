  ...
  <SfAccordionItem v-if="facet" v-model="open">
    ...
    <div v-else class="mb-4">
      <SfListItem
        ...
        class="px-1.5 bg-transparent hover:bg-transparent active:bg-transparent"
      >
        <template #prefix>
          <SfCheckbox
            ...
            :id="filter.id"
            @change="facetChange"
            class="flex items-center text-primary-500 enabled:hover:!text-primary-400 active:text-primary-400"
          />
        </template>
        <p class="select-none">
