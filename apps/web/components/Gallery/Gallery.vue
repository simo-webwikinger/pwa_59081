<template>
  <div class="flex-col md:flex-col-reverse h-full flex scroll-smooth md:gap-4 relative" data-testid="gallery">
    <div
    ...
    <div class="md:-order-1 overflow-hidden flex-shrink-0 basis-auto mx-auto">
      <SfScrollable
        ref="thumbsReference"
