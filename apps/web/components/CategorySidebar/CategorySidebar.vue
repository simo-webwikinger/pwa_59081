<template>
  ...
  >
    <SfDrawer
      ...
      :disable-esc="true"
      class="w-full shadow-none md:translate-x-0 z-[100] text-white md:z-0 md:static md:!block -translate-x-full shrink-0 md:w-[303px] bg-primary-900 overflow-y-auto"
