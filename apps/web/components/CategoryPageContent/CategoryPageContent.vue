  ...
  <NarrowContainer class="mb-20 px-4 md:px-0" data-testid="category-layout">
    ...
    <div class="md:flex gap-6" data-testid="category-page-content">
      ...
      <div class="flex-1">
        ...
        <div class="mt-4 mb-4 typography-text-xs flex gap-1 text-white" v-if="totalProducts > 0">
          ...
          <i18n-t keypath="excludedShipping" scope="global">
            <template #shipping>
              <SfLink
                ...
                target="_blank"
                class="focus:outline focus:outline-offset-2 focus:outline-2 outline-secondary-600 rounded !text-secondary-500"
              >
                {{ $t('delivery') }}
              </SfLink>
            </template>
