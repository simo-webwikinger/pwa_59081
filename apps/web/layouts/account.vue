      ...
      <div class="md:flex gap-10" data-testid="account-page-sidebar">
        ...
        >
          ...
          >
            ...
            <li v-for="({ label, link }, subIndex) in getSubsections(subsections)" :key="`subsection-${subIndex}`">
              <SfListItem
                ...
                :to="localePath(link)"
                :class="[
                  'first-of-type:py-4 md:first-of-type:px-4 md:first-of-type:py-2 rounded-md hover:text-black active:bg-primary-100 text-neutral-100',
                  {
                    'font-medium bg-primary-100 !text-primary-500': router.currentRoute.value.path === localePath(link),
                  },
                ]"
              >
          ...
          <ul>
            <SfListItem
              @click="logOut"
              class="py-4 md:py-2 mt-4 rounded-md active:bg-primary-100 hover:text-black text-neutral-100"
